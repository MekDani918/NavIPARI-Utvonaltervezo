	...
	<div class="position-fixed bottom-0 end-0" id="cornerMenu">
		...
		<div class="bg-dark m-2 p-1 text-center rounded">
			<div class="btn-group-vertical w-100 rounded" id="floorBtnGroup">
				...
				<input type="button" value="0" class="btn btn-primary active"> -->
			</div>
		</div>
	</div>
    ...
    <div class="vh-100 overflow-auto">
        ...
        <div id="newNodePanel" class="bg-dark text-white p-3 p-lg-4 m-0 m-md-2 w-25 rounded">
            <form id="newNodeForm">
                <div class="row">
                    <!-- <div class="col-12">
                        <label class="form-label" for="">Csomópont neve</label>
                        <input class="form-control" type="text" id="newNodeName">
                    </div> -->
    
                    <!-- <div class="form-check mt-2">
                        <input class="form-check-input" type="checkbox" id="newNodeIsRoom">
                        <label class="form-check-label" for="">Terem</label>
                    </div> -->
                    ...
                    <div class="col-12">
                        ...
                        <ul class="list-group mt-1" id="newNodeNeighbourList">
                            <!-- <li class="list-group-item">asd1</li> -->
                        </ul>
                    </div>
                    
                    <!-- TODO: Telefonon ha elfordítod és vissza akkor elromlik a menügomb -->
                    <!-- TODO: Útvonal tervezése után menüt be kéne zárni -->

                    <!-- <div class="col-12 mt-2">
                        <label class="form-label mt-2" for="">Egyéb elnevezések</label>
                        <input class="form-control" type="text" id="newNodeAlias">
                        <input class="btn btn-light mt-1 w-100" type="button" id="newNodeAddAlias" value="Elnevezés hozzáadása">
                        <ul class="list-group mt-1" id="newNodeAliasList">
                            <li class="list-group-item">asd2</li>
                        </ul>
                    </div> -->
		...
		<div class="bg-dark collapsed" id="menuDiv">
			<!-- <div class="px-2 px-md-3 my-0 pt-1 pt-md-2 h-100 text-white"> -->
